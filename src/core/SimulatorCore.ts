...
export class SimulatorCore {
  ...
  step(): StepDiagnostics {
    ...
    const diagnostic: StepDiagnostics = {
      ...
      maximumPreCorrectionAgentPenetration: preCorrection.maxAgentPenetration,
      maximumPreCorrectionWallPenetration: preCorrection.maxWallPenetration,
      maximumPostCorrectionAgentPenetration: postCorrection.maxAgentPenetration,
      maximumPostCorrectionWallPenetration: postCorrection.maxWallPenetration,
      ...
      minimumPreCorrectionAgentClearance: preCorrection.minimumAgentClearance,
      minimumPreCorrectionWallClearance: preCorrection.minimumWallClearance,
